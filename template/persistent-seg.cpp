...
// PersistentSeg实现了如下函数功能

// init(int l, int r) 初始化，l = 左端点, r = 右端点
// update(int p, int pos, int val) 更新，p = 当前节点, pos = 更新位置, val = 值
// query(int p, int pos) 查询，p = 当前节点, pos = 查询位置
// query(int p, int l, int r, int k) 区间查询，p = 当前节点, l = 左端点, r = 右端点, k = 第k小
...
struct PersistentSeg
{
    ...
    int query(int p, int pos)
    {
        ...
        else return query(tree[p].ir, pos);
    }
};
